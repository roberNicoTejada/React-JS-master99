    ...
    return (
        ...
        <div className="col">
            <div className="card h-100 w-75 card-ancho">                                            
                ...
                <img src={props.producto.srcImagen} className="card-img-top img-fluid" loading="lazy" alt={props.producto.descripcion}/>                                                
                <div className="card-body">
                    ...
                    <button id={props.producto.id} type="button" onClick={props.onAddShoppingCart} className="btn btn-dark w-100 mt-3">
                        Agregar al carrito
